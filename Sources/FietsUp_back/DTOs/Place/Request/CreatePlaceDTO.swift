...
extension CreatePlaceDTO: Validatable {
  static func validations(_ validations: inout Validations) {
    ...
    validations.add("address", as: String.self, is: .count(1...255), required: false)
    ...
    validations.add("email", as: String.self, is: .count(1...255) && .internationalEmail, required: false)
    validations.add("website", as: String.self, is: .count(1...255) && .url, required: false)
